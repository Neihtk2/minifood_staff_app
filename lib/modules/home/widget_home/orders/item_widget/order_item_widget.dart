...
class OrdersListView extends StatelessWidget {
          ...
          children: [
            ...
            Align(
              ...
              child: IconButton(
                ...
                onPressed: () => _confirmDelete(order.id, controller),
              ),
            ),
          ],
        ),
  ...
  void _confirmDelete(String orderId, OrdersController controller) {
    Get.defaultDialog(
      title: "Xác nhận xoá",
      middleText: "Bạn có chắc chắn muốn xoá đơn hàng này?",
      textCancel: "Hủy",
      textConfirm: "OK",
